/**
 * Fails if any résumé data is still a placeholder.
 *
 * A CV is the one document where a stray `TODO` is expensive, so the deploy
 * pipeline runs this before it builds anything.
 *
